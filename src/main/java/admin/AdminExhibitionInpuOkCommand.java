...
public class AdminExhibitionInpuOkCommand implements AdminInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(res == 1) {
			...
			request.setAttribute("url", request.getContextPath()+"/AdminExhibitionList.ad");
		}
		else {
			request.setAttribute("msg", "전시 등록에 실패하였습니다.");
			request.setAttribute("url", request.getContextPath()+"/AdminExhibitionInput.ad");
		}
	}
	}
